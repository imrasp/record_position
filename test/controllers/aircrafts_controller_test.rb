...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference('Aircraft.count') do
      post aircrafts_url, params: { aircraft: { drone_type: @aircraft.drone_type, image: @aircraft.image, name: @aircraft.name } }
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { drone_type: @aircraft.drone_type, image: @aircraft.image, name: @aircraft.name } }
